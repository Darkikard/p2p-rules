...
| 文件 | 用途 | 条数 |
|------|------|------:|
| `pt-direct.txt` | PT 站点域名 → 直连 | ~190 |
| `pt-tracker-direct.txt` | PT Tracker 域名 → 直连 | ~250 |
| `bt-tracker-direct.txt` | BT 公共 Tracker → 直连 | ~50 |
| `download-direct.txt` | 下载工具 & 网盘 → 直连 | ~100 |
| `all-download-rules.txt` | 以上全部合并 → 直连 | ~590 |
| `all-download-fakeip.txt` | 以上全部合并 → FakeIP | ~590 |

> 条数每月随 [pre-dessert-sites](https://github.com/mantou568/pre-dessert-sites) 更新浮动。
